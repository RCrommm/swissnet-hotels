...
const REGIONS = ['All Destinations', 'Zermatt', 'St. Moritz', 'Verbier', 'Davos', 'Interlaken', 'Lucerne', 'Geneva', 'Zurich', 'Gstaad', 'Lugano', 'Bern', 'Basel', 'Flims', 'Crans-Montana', 'Lausanne', 'Ascona', 'Andermatt', 'Montreux', 'Grindelwald', 'Engelberg']
