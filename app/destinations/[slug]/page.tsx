...
const DESTINATIONS: Record<string, {
  ...
  'davos': {
    ...
    highlights: ['Parsenn ski area', 'World Economic Forum', 'Europe\'s highest city', 'Cross-country skiing', 'Klosters connection'],
  ...
  'crans-montana': {
    ...
    description: 'Crans-Montana sits on a spectacular sun-drenched plateau at 1,500 metres above the Rhône Valley, with panoramic views of the Valais Alps stretching from Mont Blanc to the Matterhorn. Known as the sunniest ski resort in Switzerland, it combines excellent skiing with a sophisticated resort atmosphere and world-class golf in summer.',
    highlights: ['Exceptional sunshine', 'Rhône Valley views', 'FIS World Cup piste', 'Summer golf', 'Panoramic Alps views'],
  ...
  'flims': {
    ...
    description: 'Flims is one of Switzerland\'s most beautiful and unspoiled alpine destinations, set in the heart of Graubünden\'s Romansh-speaking region. Anchoring the world-class Weisse Arena ski domain shared with Laax and Falera, it is surrounded by ancient forests, the turquoise Caumasee lake and the dramatic Ruinaulta Rhine Gorge — Switzerland\'s Grand Canyon.',
    highlights: ['Weisse Arena ski domain', 'Rhine Gorge', 'Caumasee lake', 'Romansh culture', 'Natural halfpipe'],
  ...
  'bern': {
    ...
    description: 'Bern is one of Europe\'s most beautiful and underrated capitals — a UNESCO World Heritage city of medieval arcades, bear pits and rose gardens perched above a dramatic loop of the Aare river. Home to the Swiss Federal Palace and Bellevue Palace, Switzerland\'s most politically prestigious hotel, it combines cultural depth with authentic Swiss luxury.',
    highlights: ['UNESCO old town', 'Federal Palace', 'Aare river views', 'Bernese Alps panorama', 'Medieval arcades'],
  ...
  'basel': {
    ...
    description: 'Basel is Switzerland\'s most culturally rich city, sitting at the meeting point of Switzerland, Germany and France on the banks of the Rhine. Home to Art Basel — the world\'s most prestigious art fair — and more than 40 museums, it combines exceptional cultural depth with Swiss luxury hospitality and a thriving gastronomic scene.',
    highlights: ['Art Basel', '40+ museums', 'Rhine waterfront', 'Tri-border location', 'Exceptional dining'],
  ...
  'lugano': {
    ...
    description: 'Lugano is Switzerland\'s most Mediterranean city — a sun-drenched lakeside resort in the Italian-speaking canton of Ticino, where Swiss precision meets the relaxed elegance of northern Italy. Set on the shores of Lake Lugano with dramatic mountain backdrops, it offers a unique blend of luxury hotels, Italian cuisine and Swiss culture.',
