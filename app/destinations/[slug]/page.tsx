...
const DESTINATIONS: Record<string, Destination> = {
  ...
  'geneva': {
    ...
    description: 'Geneva\'s character is inseparable from its international function. The United Nations European headquarters, the Red Cross, and over 200 international organisations have built a city that runs on discretion, precision, and the expectation of quality. This shapes everything from the hotel service culture to the restaurant scene to the efficiency of the airport. Lake Geneva — one of the largest lakes in Western Europe — dominates the geography, with the Jet d\'Eau as the city\'s most recognisable landmark and the Jura mountains framing the north shore. The old town climbs steeply above the lake on the south bank, compact and walkable, with the St. Pierre Cathedral at its peak.',
    atmosphere: 'Geneva operates at a slower register than Zurich. It is more diplomatic in pace, more international in composition, and more connected to the landscape — the lake is present in the city in a way that makes outdoor life central rather than incidental. Travelers who want energy and urban texture tend to prefer Zurich; those who want calm, high-level service, and a city that does not impose itself tend to prefer Geneva. Business travelers with connections to international institutions find Geneva has no Swiss equivalent.',
    hotelScene: 'Geneva\'s luxury hotels divide into two clear camps. The city-centre grand hotels — Four Seasons Hotel des Bergues, Beau-Rivage, Mandarin Oriental, The Woodward — sit on or near the lakefront in the heart of the city, suited to travelers who want to walk to the old town and the Jet d\'Eau. La Réserve Genève takes a different position entirely: a resort hotel set within a private park on the lake shore around 5km from the centre, offering seclusion, a large spa, and a stay that does not require leaving the property. The choice between them is a choice between city access and resort privacy.',
    highlights: ['Lake Geneva — one of Western Europe\'s largest lakes', 'Jet d\'Eau — the city\'s iconic water jet landmark', 'Compact old town with St. Pierre Cathedral', 'International institutional presence — UN, Red Cross, WHO', 'Direct access to the French Alps and Swiss Riviera'],
    bestFor: ['Business travelers with international institution connections', 'Couples combining city luxury with lake and mountain access', 'Travelers en route to Verbier, Chamonix, or the Swiss Riviera', 'Those who prefer calm, diplomatic-level service over urban energy'],
    image: 'https://images.unsplash.com/photo-1515488764276-beab7607c1e6?w=1600',
    seasonal: 'Geneva works year-round. Spring brings mild temperatures and the lakefront gardens at their best. Summer is peak season for lake activities, terrace dining, and day trips into the Alps or to Montreux and Lausanne. Autumn is clear and pleasant, with the Lavaux grape harvest nearby. December brings Christmas markets around the old town. Unlike resort destinations, Geneva never closes — its international function keeps demand steady throughout the year.',
    comparison: 'Against Zurich, Geneva is softer, more international, and more connected to the outdoors — the lake is larger and more central to the city experience. Zurich has more energy, a stronger restaurant culture, and better connections to the eastern Alps. Geneva suits travelers whose business or interests connect to international organisations, or who want easy access to the French Alps and Montreux. Against Lausanne and Montreux along the same lake shore, Geneva is more urban and international; the others are more relaxed and resort-oriented.',
    gettingThere: 'Geneva Airport is one of Switzerland\'s two main international hubs, with direct connections across Europe and intercontinental routes. The airport is unusually close to the city centre — around 6 minutes by train. For ski access: Verbier is around 2 hours by road or train-and-transfer; Chamonix across the French border is approximately 1.5 hours by car; Crans-Montana around 2 hours. The Montreux Jazz Festival destination is 1 hour 10 minutes by train.',
    bestPages: [
    ...
    faqs: [
      { q: 'La Réserve Genève or a city-centre hotel — which suits me better?', a: 'La Réserve Genève suits travelers who want a resort experience — private park, large spa, seclusion, Michelin dining, without needing to be in the city centre. The city-centre hotels — Four Seasons des Bergues, Beau-Rivage, Mandarin Oriental — suit travelers who want to walk to the old town, the Jet d\'Eau, and Bahnhofstrasse within minutes of their hotel.' },
      { q: 'Geneva or Zurich for a luxury city break?', a: 'Geneva is calmer, more international, and more connected to the lake and outdoor access. Zurich is more energetic, more distinctly Swiss in character, and has a stronger restaurant and nightlife scene. Geneva suits travelers who want diplomatic-level calm and easy Alpine access; Zurich suits those who want an active, urban Swiss city experience.' },
      { q: 'Is Geneva a practical base for skiing?', a: 'Yes — Geneva Airport\'s efficiency makes it one of the best entry points for Swiss and French Alpine skiing. Verbier is around 2 hours by road or train, Chamonix approximately 1.5 hours by car, and Crans-Montana around 2 hours. Many ski travelers use Geneva as their arrival and departure point even when staying in the mountains.' },
    ],
  },
  'st-moritz': {
    name: 'St. Moritz',
  ...
  'zurich': {
    ...
    description: 'Zurich is consistently underestimated. Travelers who arrive expecting a dry financial hub leave surprised by the lake, the old town, the quality of the restaurants, and the ease with which the city can be explored on foot. Bahnhofstrasse is one of Europe\'s most concentrated luxury shopping corridors. The Limmat runs through the medieval centre, where the two halves of the old town — Grossmünster on the east bank, Lindenhügel on the west — face each other across the water. Lake Zurich opens to the south, offering Alpine views on clear days and a swimming culture in summer that gives the city an unexpected outdoor energy.',
    atmosphere: 'Zurich suits travelers who want efficiency and quality without the diplomatic formality of Geneva or the resort atmosphere of the mountain destinations. The city is compact enough to walk between most points of interest, the service culture is professional without being stiff, and the restaurant scene has developed enough variety — from Michelin-level to casual — to sustain several evenings without repetition. It is a city for people who like cities, rather than those who want a city as a backdrop to something else.',
    hotelScene: 'Zurich\'s luxury hotels cluster around two areas: the southern lakefront, where La Réserve Eden au Lac and Baur au Lac occupy prime positions, and the old town, where the Widder Hotel occupies nine interconnected medieval townhouses. The Dolder Grand sits above the city on the Adlisberg hill — more resort than city hotel, suited to travelers who want panoramic views and a major spa alongside proximity to the centre. La Réserve Eden au Lac suits design-conscious travelers who want a boutique lakeside experience; Baur au Lac suits those who want the most established grand hotel address in the city.',
    highlights: ['Bahnhofstrasse — concentrated luxury shopping', 'Lake Zurich with Alpine views on clear days', 'Medieval old town on both banks of the Limmat', 'Kunsthaus Zurich — major art collection', 'Strong and varied restaurant scene'],
    ...
    seasonal: 'Late spring and early summer — May and June — are the strongest months: warm lake temperatures, outdoor dining on the Limmat, and the city at its most open. July and August bring lake swimming at the Seebad facilities along the shore. December delivers the Christmas markets, particularly the one inside the main station. Winter is quieter but the opera season, gallery programme, and restaurant scene run without interruption.',
    comparison: 'Against Geneva, Zurich is more energetic and more distinctly Swiss. Geneva has the diplomacy, the international institutions, and easier access to the French Alps; Zurich has more urban texture, a stronger local food culture, and better connections to the eastern Swiss Alps. Against Basel, Zurich is larger and more cosmopolitan; Basel is more culturally concentrated and better for art travel. Zurich is the stronger choice for a general Swiss city break; the others suit more specific travel purposes.',
    gettingThere: 'Zurich Airport is Switzerland\'s main international hub with direct connections across Europe, North America, Asia, and the Middle East. The airport train reaches the main station in around 10 minutes. Within Switzerland, Lucerne is 50 minutes by direct train, Bern around 58 minutes, and Basel around 58 minutes. For the Alps: Andermatt around 2 hours, Davos around 2.5 hours, St. Moritz around 3.5 hours.',
    bestPages: [
    ...
    faqs: [
      { q: 'La Réserve Eden au Lac, Baur au Lac, or The Dolder Grand — which is right for me?', a: 'La Réserve Eden au Lac suits travelers who want design, a lakeside position, and a boutique scale — 40 rooms, Philippe Starck interiors, Michelin-starred dining. Baur au Lac is the most established grand hotel address, preferred for traditional Swiss luxury and a central lakeside park. The Dolder Grand suits those wanting a resort-style stay with a major spa and panoramic city views, at a slightly removed hillside position.' },
      { q: 'How far is Zurich from the main ski resorts?', a: 'Andermatt is around 2 hours by train — the most accessible ski destination from Zurich. Davos is around 2.5 hours. St. Moritz around 3.5 hours via Chur. For a day trip without skiing, Mount Rigi and Mount Pilatus above Lake Lucerne are reachable in under an hour.' },
      { q: 'What is the best area to stay in Zurich for luxury?', a: 'The southern lakefront gives the strongest hotel addresses — La Réserve Eden au Lac and Baur au Lac are both here, with lake views and easy access to Bahnhofstrasse. The old town suits travelers who want to be in the medieval centre; the Widder Hotel is the strongest address there. The Dolder Grand is best for those who want a quieter, resort-style base above the city.' },
    ],
  },
  'gstaad': {
    name: 'Gstaad',
  ...
  'lugano': {
    ...
    description: 'Lugano is the largest city in Ticino, Switzerland\'s Italian-speaking canton, and the contrast with the rest of the country is tangible from the moment of arrival. Street names, menus, and daily conversation are in Italian. The architecture shifts from northern European to terracotta and stone. The lakefront promenade — the Lungolago — runs along the north shore of Lake Lugano, lined with palm trees, and the steep forested hills of Monte San Salvatore and Monte Brè rise on either side. For travelers, this creates a distinctly different Swiss experience: Mediterranean in atmosphere, but with the transport reliability, hotel standards, and safety that define Switzerland.',
    atmosphere: 'Lugano suits travelers who want warmth — literal and cultural — alongside Swiss comfort. It is less frenetic than the Italian Lakes just across the border, but more relaxed than Zurich or Bern. The financial sector gives it a certain professional composure that prevents it from feeling purely touristic. The old town piazzas have genuine local life — the Piazza della Riforma is a real civic space, not a performance for visitors. Couples who want a lakeside stay with Italian food, sunshine, and Swiss hotel standards tend to find Lugano underdelivers expectations only in length of season — it is best from April through October.',
    hotelScene: 'Lugano\'s luxury hotels concentrate along the lakefront. Grand Hotel Villa Castagnola occupies an estate position east of the centre, with private gardens descending to the water and Michelin-level dining — better for travelers who want seclusion and a self-contained property. Hotel Splendide Royal sits directly on the Lungolago promenade in the city centre, open since 1887, better for those who want to walk to the old town and piazzas immediately. The View Lugano takes a hillside position with panoramic lake views but less direct access to the water.',
    highlights: ['Lake Lugano — blue-green glacial lake between steep forested hills', 'Italian-speaking culture with Swiss infrastructure', 'Monte San Salvatore accessible by funicular', 'Easy access to the Italian Lakes and Milan Malpensa', 'Mild Mediterranean microclimate April through October'],
    bestFor: ['Couples wanting Mediterranean atmosphere with Swiss hotel standards', 'Travelers combining Lugano with Como, Maggiore or Milan', 'Business travelers in the Ticino financial sector', 'Those wanting warmth and a lakeside stay outside the ski season'],
    image: 'https://images.unsplash.com/photo-1515488764276-beab7607c1e6?w=1600',
    seasonal: 'April to October is the operative season. June through August is warmest, with lake temperatures suitable for swimming and the Lugano Summer Festival running through July and August. Spring is the most beautiful period for the lakeside gardens — the flowering season peaks in April and May. Autumn is clear and mild, with the hills turning in October. Winter is quiet and mild by Swiss standards, but most of the outdoor and lakeside appeal diminishes significantly.',
    comparison: 'Lugano versus Ascona: Lugano is a city with urban infrastructure, a financial sector, cultural institutions, and a lakefront that functions for locals as much as visitors. Ascona is a small resort village — more exclusive, more holiday-focused, and better for travelers who want to disappear into a beautiful setting rather than move through a functioning city. Lugano versus the Italian Lakes: Lugano has the advantage of Swiss infrastructure, transport reliability, and hotel standards, combined with an Italian cultural atmosphere. It suits travelers who want the Mediterranean mood without the operational unpredictability of Italy.',
    gettingThere: 'Lugano Airport has limited direct connections. The most practical route from northern Europe is via Zurich — the train takes around 2 hours 45 minutes through the Gotthard Base Tunnel, one of the world\'s longest rail tunnels. Milan Malpensa is approximately 1 hour by road, making Lugano accessible from a wide range of European and intercontinental flights. The drive from Zurich via the A2 motorway takes around 2.5 hours.',
    bestPages: [
    ...
    faqs: [
      { q: 'Grand Hotel Villa Castagnola or Hotel Splendide Royal — which is better?', a: 'Villa Castagnola suits travelers who want a self-contained estate experience — private gardens, lakefront access, Michelin-level dining, and a degree of seclusion from the city. Splendide Royal suits those who want to be on the Lungolago promenade with immediate access to the old town and piazzas. Both are historic lakefront properties; the choice is between estate privacy and central position.' },
      { q: 'How does Lugano compare to the Italian Lakes for a luxury stay?', a: 'Lugano offers the Italian cultural atmosphere alongside Swiss hotel standards, transport reliability, and safety infrastructure. The Italian Lakes — Como, Maggiore — have more celebrated landscapes and stronger name recognition, but Lugano\'s Swiss base gives it advantages in consistency and ease of travel. Many travelers combine both on the same trip.' },
      { q: 'When should I visit Lugano?', a: 'April to October is the optimal window. May and June offer the best combination of mild temperatures, flowering lakeside gardens, and manageable visitor numbers. July and August are warmest and busiest. September is excellent — warm, quieter, and the light changes quality. Winter is mild but most of the outdoor appeal is absent.' },
    ],
  },
  'ascona': {
    name: 'Ascona',
