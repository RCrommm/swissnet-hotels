...
const DESTINATIONS: Record<string, Destination> = {
  'zermatt': {
    ...
    description: 'Zermatt is not simply Switzerland\'s most famous mountain resort — it is one of the few places in the world where the landscape genuinely overwhelms. The Matterhorn does not appear gradually; it dominates the horizon the moment you step off the train, and it never quite loses its effect. What surprises most first-time visitors is how the village underneath it manages to feel simultaneously intimate and world-class: car-free cobblestone streets, wood-clad chalets, Michelin-starred restaurants tucked between ski rental shops. For luxury travelers, Zermatt offers something increasingly rare — a destination that earns its reputation every single visit.',
    highlights: ['Direct Matterhorn views from the village', 'Car-free village with electric taxis only', '360 km of pistes across three linked valleys', 'Year-round glacier skiing at 3,883m', 'Three Michelin-starred restaurants', 'Historic grand hotels open since the 1800s'],
    ...
    seasonal: 'December to April delivers the full Zermatt experience — deep snow, atmospheric village lighting, and the mountain at its most dramatic. July and August offer a completely different but equally compelling stay: wildflower meadows at altitude, hiking to the base of the Matterhorn, and the glacier open for summer skiing. The shoulder seasons (May, June, October, November) see most hotels close for refurbishment. If you can only visit once, late January to mid-March combines reliable snow with the best light for photography.',
    bestPages: [
    ...
    faqs: [
      { q: 'What is the best luxury hotel in Zermatt?', a: 'Mont Cervin Palace is the benchmark — a 5-star grand hotel open since 1852 with the most complete offering in the village: 150 rooms, a 1,700 m² spa, one Michelin-starred restaurant, and a central position with direct Matterhorn views. For travelers seeking something more intimate, Cervo Mountain Resort offers a boutique ski-lodge experience with exceptional food and a younger, more design-conscious atmosphere.' },
      { q: 'Why choose Zermatt over St. Moritz?', a: 'Zermatt and St. Moritz attract subtly different travelers. Zermatt is more focused on the mountain itself — the Matterhorn gives the resort an identity that no other Swiss destination can match, and the car-free village creates a more intimate, walkable atmosphere. St. Moritz has a more social, seen-and-be-seen energy, with frozen lake events and a longer tradition of ultra-wealthy clientele. Zermatt tends to appeal more to travelers who want the skiing and the landscape to be the main event.' },
      { q: 'Is Zermatt suitable for non-skiers in winter?', a: 'Absolutely. The village itself is one of the most pleasant in the Alps to explore on foot — the Bahnhofstrasse lined with luxury boutiques and restaurants, horse-drawn sledge rides, snowshoe trails, and some of the best mountain-view dining in Switzerland. Non-skiers at Mont Cervin Palace or Schweizerhof Zermatt rarely feel left out.' },
    ],
  },
  'geneva': {
    name: 'Geneva',
    ...
    description: 'Geneva operates at a different register to most Swiss cities. It is international in a way that feels structural rather than cosmetic — the United Nations, the Red Cross, and dozens of global institutions have shaped a city that is accustomed to hosting people for whom discretion and excellence are non-negotiable. The lake is central to everything: Lake Geneva is vast enough to feel like a sea on overcast days, with the Jet d\'Eau marking the skyline and the Jura mountains framing the north shore. For luxury travelers, Geneva offers some of Switzerland\'s most accomplished hotels and restaurants, a level of service professionalism that reflects its international clientele, and a compact old town that rewards walking.',
    highlights: ['Lake Geneva waterfront and the Jet d\'Eau', 'Immediate access to the Alps and French countryside', 'Some of Switzerland\'s finest Michelin-starred dining', 'International atmosphere with Swiss precision', 'Direct flights from most major global cities'],
    bestFor: ['Business travelers requiring proximity to international institutions', 'Couples combining city luxury with lake and mountain access', 'Travelers en route to the Swiss Riviera or French Alps', 'Those seeking urban sophistication with outdoor access'],
    image: 'https://images.unsplash.com/photo-1515488764276-beab7607c1e6?w=1600',
    seasonal: 'Geneva works year-round. Spring brings the famous flower clock and mild lakeside temperatures ideal for walking. Summer is peak season for lake activities, terrace dining, and easy day trips into the Alps. Autumn offers clear mountain views and the grape harvest in nearby Lavaux. December brings Christmas markets around the old town. The city never fully closes — its international function keeps hotel occupancy high throughout the year.',
    bestPages: [
    ...
    faqs: [
      { q: 'What is the best luxury hotel in Geneva?', a: 'La Réserve Genève stands apart from the city-centre grand hotels by offering a genuine resort experience — set within a private park on the lake shore, around 5km from the centre, with a 2,000 m² spa and consistently ranked among Switzerland\'s top hotels. For travelers who want to be in the heart of the city, Four Seasons Hotel des Bergues and Beau-Rivage Geneva offer the classic lakeside grand hotel experience with direct views of the Jet d\'Eau.' },
      { q: 'Why choose Geneva over Zurich for a luxury city break?', a: 'Geneva and Zurich serve different moods. Geneva is softer, more international, and more connected to the outdoors — the lake dominates the city in a way that Zurich\'s lake does not. Zurich has more energy, a stronger restaurant and nightlife scene, and a more distinctly Swiss urban character. Geneva suits travelers who want calm, diplomatic-level service, and easy access to the French Alps or Montreux.' },
      { q: 'How far is Geneva from the ski resorts?', a: 'Geneva is exceptionally well positioned for ski access. Verbier is around 2 hours by road or train-and-transfer. Chamonix across the French border is 1.5 hours by car. Crans-Montana is around 2 hours. The airport\'s efficiency makes Geneva a practical base for ski trips that also require city meetings or connections.' },
    ],
  },
  'st-moritz': {
    name: 'St. Moritz',
  ...
  'interlaken': {
    ...
    tagline: 'Between two lakes, beneath three peaks — Switzerland\'s most dramatic setting.',
    description: 'Interlaken\'s geography is its defining quality. The town sits on a narrow strip of land between Lake Thun and Lake Brienz, with the Eiger, Mönch, and Jungfrau rising directly to the south — a backdrop so theatrical it can feel almost artificially composed. What distinguishes Interlaken from other Swiss resort towns is the combination of grand hotel heritage and genuine outdoor access: the Victoria-Jungfrau has been operating since 1865, yet within thirty minutes you can be at the base of one of the most famous mountain faces in the Alps. For luxury travelers, Interlaken works as both a destination in itself and an ideal base for the wider Jungfrau region — Grindelwald, Wengen, Lauterbrunnen, and the Jungfraujoch are all within easy reach.',
    highlights: ['Direct views of the Eiger, Mönch and Jungfrau', 'Gateway to Jungfraujoch — Top of Europe at 3,454m', 'Lake Thun and Lake Brienz on either side', 'Grand hotel heritage dating to the 19th century', 'Access to Grindelwald, Wengen and Lauterbrunnen valleys'],
    bestFor: ['Families combining luxury with adventure', 'Couples seeking dramatic scenery without a ski-only focus', 'Wellness travelers at Victoria-Jungfrau\'s major spa', 'Travelers exploring the broader Bernese Oberland'],
    image: 'https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=1600',
    seasonal: 'Summer — June to September — is when Interlaken is at its best. The Jungfrau region hiking trails open, the lakes warm enough for swimming, and the mountain views are clearest in the early morning light. Winter brings access to the Jungfrau ski region from Grindelwald and Wengen, though Interlaken itself sits at low altitude and rarely gets snow in the town. Spring and autumn are quieter and often underrated — the valley light in October is exceptional.',
    bestPages: [
  ...
  'zurich': {
    ...
    description: 'Zurich has spent years being underestimated by international travelers who treat it as a stopover rather than a destination. That is changing. The city\'s financial core still dominates — Bahnhofstrasse remains one of Europe\'s most concentrated luxury shopping streets — but the broader city has developed a restaurant scene, a design hotel culture, and a lakeside energy that rewards longer stays. The old town sits on both banks of the Limmat river, the lake opens south with mountain views on clear days, and the density of world-class museums within walking distance is genuinely impressive. For luxury travelers, Zurich offers a rare combination: Swiss operational excellence, a compact and walkable centre, and hotels ranging from historic grand properties to Philippe Starck-designed boutiques on the water.',
    highlights: ['Bahnhofstrasse luxury shopping', 'Lake Zurich with Alpine views on clear days', 'Old town on both banks of the Limmat', 'Outstanding museums including Kunsthaus Zurich', 'Strong Michelin-starred dining scene'],
    ...
    seasonal: 'Zurich is strongest in spring and early summer — May and June bring warm lake temperatures, outdoor dining on the Limmat, and the city at its most photogenic. July and August are peak season with lake swimming at the Seebad facilities. December brings the Christmas markets, particularly the one inside the main station. Winter is quieter but the city never stops — the opera, galleries, and restaurant scene run year-round.',
    bestPages: [
    ...
    faqs: [
      { q: 'What is the best luxury hotel in Zurich?', a: 'The answer depends on what kind of stay you want. La Réserve Eden au Lac is the strongest choice for travelers who want a design-led boutique experience directly on the lake — 40 rooms, Philippe Starck interiors, and a Michelin-starred restaurant. Baur au Lac is the city\'s most established grand hotel, preferred by travelers who want traditional Swiss luxury and a central position on the lake shore. The Dolder Grand suits those wanting a resort experience with a major spa, slightly removed from the city centre on a hillside above Zurich.' },
      { q: 'How far is Zurich from the Swiss Alps?', a: 'Zurich is one of the best-connected cities in Switzerland for mountain access. Andermatt is around 2 hours by train, Davos around 2.5 hours, and St. Moritz around 3.5 hours. For a day trip, the Rigi and Pilatus mountains above Lake Lucerne are reachable in under an hour.' },
      { q: 'Is Zurich good for a weekend luxury break?', a: 'Zurich is well-suited to two or three night stays. The old town, lake promenade, Bahnhofstrasse, and Kunsthaus can be covered comfortably in a day, leaving time for a day trip to Lucerne or a half-day on the lake. The restaurant scene has enough depth to justify staying in for both evenings.' },
    ],
  },
  'gstaad': {
    name: 'Gstaad',
  ...
  'davos': {
    ...
    tagline: 'Europe\'s highest city — serious skiing, serious reputation.',
    description: 'Davos occupies a curious position in the Swiss luxury landscape. It is simultaneously one of the country\'s most functional ski resorts — Europe\'s highest city at 1,560m, with direct access to the vast Parsenn ski area — and a place carrying an unusually heavy layer of global significance through the World Economic Forum. For luxury travelers who are not WEF delegates, this actually works in their favour outside of January: the infrastructure is excellent, the hotels are accustomed to demanding international guests, and the resort has a more understated, less showy atmosphere than St. Moritz or Gstaad. Davos rewards travelers who want serious mountain access with high-level comfort, without the social performance that defines some other Alpine destinations.',
    highlights: ['Access to the Parsenn ski area — one of Switzerland\'s largest', 'Europe\'s highest city at 1,560m altitude', 'Strong congress and business infrastructure', 'Davos Lake for summer activities', 'Connection to Klosters via the Parsenn lifts'],
    bestFor: ['Serious skiers who want luxury without the social scene', 'Business travelers attending conferences', 'Families wanting a spacious, well-equipped resort', 'Travelers who prefer Graubünden\'s quieter character over Valais celebrity culture'],
    image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1600',
    seasonal: 'December to March for skiing, with January dominated by the World Economic Forum — book well in advance if traveling that month, as rates increase significantly and the town fills with security and delegates. February and March offer the best combination of snow reliability and normal resort atmosphere. Summer — July and August — is underrated: the Davos Lake, mountain biking trails, and walking paths through the Flüela and Dischma valleys offer genuine outdoor quality without ski-season crowds.',
    bestPages: [
    ...
    faqs: [
      { q: 'What is the best luxury hotel in Davos?', a: 'Alpengold Hotel is the strongest luxury choice in Davos — a 5-star property with a distinctive organic architecture, a 1,200 m² spa, multiple restaurants, and direct access to the Parsenn ski area. For travelers who prefer a more traditional grand hotel atmosphere, Steigenberger Grandhotel Belvédère has been welcoming guests since 1875 and maintains a classic Alpine hospitality style.' },
      { q: 'How does Davos compare to Klosters?', a: 'Davos and Klosters share the same ski area via the Parsenn lifts, but feel completely different as villages. Klosters is smaller, quieter, and more discreet — traditionally preferred by guests who want privacy and a chalet-village atmosphere. Davos is larger, more functional, and better equipped for longer stays with a wider range of restaurants and facilities. They are around 10 minutes apart by train.' },
      { q: 'Should I avoid Davos during the World Economic Forum?', a: 'Unless you are attending, late January in Davos is not ideal — security measures are extensive, some areas are restricted, and prices peak significantly. The weeks immediately before (early January) and after (February) offer the same skiing with a much more relaxed atmosphere.' },
    ],
  },
  'crans-montana': {
    name: 'Crans-Montana',
