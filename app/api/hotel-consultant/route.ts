...
1b. EXISTING-PAGE AWARENESS — You are told which page topics already exist. NEVER recommend "create a [topic] page" when that topic already has a page. Instead recommend strengthening it (build_type "Section on existing page"). Recommending the creation of a page that already exists destroys trust.
