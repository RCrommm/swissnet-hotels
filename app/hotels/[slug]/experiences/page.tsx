...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!hotelMeta) return {}
  return {
    title: `${hotelMeta.name} — Experiences & Activities | SwissNet Hotels`,
    ...
    <div style={{ background: bg, minHeight: '100vh' }}>
      ...
      <div style={{ background: '#F8F5EF', padding: '6rem 2rem 3rem' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <h1 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 'clamp(2rem, 4vw, 3.5rem)', fontWeight: 300, color: text, margin: '0 0 0.5rem', lineHeight: 1.1 }}>Experiences &amp; Activities</h1>
