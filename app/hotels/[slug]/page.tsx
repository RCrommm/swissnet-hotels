...
function SchemaMarkup({ hotel, keywords, roomTypes, faqs, restaurants, spaData, awards }: any) {
  ...
  const graph: any[] = [
    // WebPage
    {
        ...
        ...(hotel.about_us ? { 'disambiguatingDescription': hotel.about_us } : {}),
        ...(hotel.cancellation_policy ? { 'tourBookingPage': hotel.cancellation_policy } : {}),
...(hotel.seasonal_notes ? { 'temporalCoverage': hotel.seasonal_notes } : {}),
...(hotel.booking_benefits ? { 'offers': { '@type': 'Offer', 'description': hotel.booking_benefits } } : {}),
        inLanguage: ['en', 'fr', 'de'],
    ...
    // Hotel
    {
      ...
      name: hotel.name,
      description: hotel.description,
      ...(hotel.description_fr ? { 'description-fr': hotel.description_fr } : {}),
      ...(hotel.description_de ? { 'description-de': hotel.description_de } : {}),
      url: pageUrl,
      ...
      ...(hotel.rating_value && hotel.rating_count ? {
        aggregateRating: {
          '@type': 'AggregateRating',
          ratingValue: hotel.rating_value,
...
availableLanguage: hotel.languages ? hotel.languages.split(',').map((l: string) => l.trim()) : undefined,
petsAllowed: hotel.pet_friendly || undefined,
      amenityFeature: [
  ...
  hotel.has_spa && { '@type': 'LocationFeatureSpecification', name: 'Spa', value: true },
  hotel.ski_in_ski_out && { '@type': 'LocationFeatureSpecification', name: 'Ski-in / Ski-out access', value: true },
  hotel.lake_view && { '@type': 'LocationFeatureSpecification', name: 'Lake view', value: true },
  hotel.mountain_view && { '@type': 'LocationFeatureSpecification', name: 'Mountain view', value: true },
  hotel.lakefront && { '@type': 'LocationFeatureSpecification', name: 'Lakefront location', value: true },
  hotel.family_friendly && { '@type': 'LocationFeatureSpecification', name: 'Family friendly', value: true },
  hotel.pet_friendly && { '@type': 'LocationFeatureSpecification', name: 'Pet friendly', value: true },
  hotel.parking && { '@type': 'LocationFeatureSpecification', name: hotel.parking, value: true },
  hotel.private_transfer && { '@type': 'LocationFeatureSpecification', name: 'Airport transfer available', value: true },
hotel.accessibility && { '@type': 'LocationFeatureSpecification', name: hotel.accessibility, value: true },
  hotel.has_michelin_restaurant && { '@type': 'LocationFeatureSpecification', name: 'Michelin-starred restaurant', value: true },
  hotel.wellness_focus && { '@type': 'LocationFeatureSpecification', name: 'Wellness focus', value: true },
  hotel.near_ski_lifts && { '@type': 'LocationFeatureSpecification', name: 'Near ski lifts', value: true },
  hotel.romantic && { '@type': 'LocationFeatureSpecification', name: 'Romantic setting', value: true },
  hotel.business_hotel && { '@type': 'LocationFeatureSpecification', name: 'Business facilities', value: true },
  hotel.central_location && { '@type': 'LocationFeatureSpecification', name: 'Central location', value: true },
].filter(Boolean),
