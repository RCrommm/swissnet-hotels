...
const PROMPT_PAGES: Record<string, PromptPageConfig> = {
  ...
  'ski-hotels-davos': {
    ...
    hotels: [
      'Alpengold Hotel',
      'Steigenberger Icon Grandhotel Belvédère Davos',
  ...
  'luxury-hotels-gstaad': {
    ...
    faqs: [
      { q: 'What is the best luxury hotel in Gstaad?', a: 'The Alpina Gstaad and Gstaad Palace are two of the standout luxury hotels in Gstaad.' },
  ...
  'luxury-hotels-basel': {
    ...
    faqs: [
      { q: 'What is the best luxury hotel in Basel?', a: 'Grand Hotel Les Trois Rois is Basel’s most iconic luxury hotel, with a historic riverside setting.' },
  ...
  'luxury-hotels-ascona': {
    ...
    hotels: [
      ...
      'Hotel la Meridiana Ascona',
      'Hotel Tobler Ascona',
      'Casa Berno Panorama Resort',
      'Delta Resort Ascona',
    ],
    faqs: [
      { q: 'What is the best luxury hotel in Ascona?', a: 'Eden Roc Ascona and Castello del Sole Ascona are two of Ascona’s standout luxury hotels.' },
