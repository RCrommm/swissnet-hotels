      ...
      <section style={{ position: 'relative', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', maxWidth: '900px', margin: '0 auto', padding: '0 2rem' }}>
          ...
          <p style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '0.85rem', fontWeight: 300, color: 'rgba(255,255,255,0.7)', lineHeight: 1.8, maxWidth: '560px', margin: '0 auto 2.5rem' }}>
            SwissNet AI helps luxury hotels appear in ChatGPT, Claude, Gemini, Perplexity and AI travel search — while reducing OTA dependence.
          </p>
...
{ icon: '◆', title: 'Direct Bookings', desc: 'Increase direct bookings while reducing reliance on high OTA commissions. Guests official websitely with you, not through intermediaries.' },
    ...
    <div style={{ background: '#FFFFFF', border: '1px solid ' + gold + '55', padding: '3rem', position: 'relative' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '2.5rem', marginBottom: '2.5rem', paddingBottom: '2.5rem', borderBottom: '1px solid rgba(201,169,110,0.2)' }}>
       ...
       <div>
          ...
          <p style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '0.58rem', color: '#C9A84C', margin: '0.3rem 0 0', fontWeight: 500, letterSpacing: '0.05em' }}>No commission on bookings</p>
        </div>
      </div>
      ...
      <footer style={{ background: '#2A1208', borderTop: '1px solid rgba(201,169,110,0.2)', padding: '4rem 0 2rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '3rem' }}>
          ...
          <div>
            ...
            <a href="/about" style={{ display: 'block', fontFamily: 'Montserrat, sans-serif', fontSize: '0.7rem', color: 'rgba(255,255,255,0.4)', textDecoration: 'none', marginBottom: '0.5rem', fontWeight: 300 }}>About</a>
          ...
          <div>
            <p style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '0.6rem', fontWeight: 500, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)', marginBottom: '1rem' }}>Legal</p>
            <a href="/privacy" style={{ display: 'block', fontFamily: 'Montserrat, sans-serif', fontSize: '0.7rem', color: 'rgba(255,255,255,0.4)', textDecoration: 'none', marginBottom: '0.5rem', fontWeight: 300 }}>Privacy Policy</a>
            <a href="/terms" style={{ display: 'block', fontFamily: 'Montserrat, sans-serif', fontSize: '0.7rem', color: 'rgba(255,255,255,0.4)', textDecoration: 'none', marginBottom: '0.5rem', fontWeight: 300 }}>Terms &amp; Conditions</a>
          </div>
        </div>
